...
const STEPS = [
  ...
  },
  {
    icon: Sparkles,
    title: "Animate",
    body: "Fade, slide, scale, rotate, color-shift, spotlight, particle, typewriter. Drag blocks on the timeline. Scrub and play. Fireworks powered by fireworks-js (MIT).",
  },
  {
    icon: Download,
    title: "Export",
